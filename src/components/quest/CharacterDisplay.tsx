    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <Card className="bg-gradient-to-br from-purple-900/20 to-blue-900/20 border-purple-500/30 backdrop-blur-sm">
        <CardHeader className="text-center">
          ...
          <p className="text-blue-200">{classData.name}</p>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3 pt-2">
            <div className="text-center p-2 rounded bg-black/20">
              <div className="text-2xl font-bold text-green-400">{character.totalTasksCompleted}</div>
              <div className="text-xs text-gray-300">Tasks Completed</div>
            </div>
            <div className="text-center p-2 rounded bg-black/20">
              <div className="text-2xl font-bold text-blue-400">{Math.floor(character.totalFocusMinutes / 60)}h</div>
        ...
        <CardContent className="space-y-4">
              ...
              <div key={statName} className="space-y-2">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-white capitalize">{statName}</span>
                  </div>
          ...
          <div className="pt-4 border-t border-gray-600">
            <div className="text-sm text-blue-200">
              <strong>Class Bonus:</strong> {classData.description}
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="pt-4 border-t border-gray-600 space-y-3">
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="text-white">{new Date(character.joinDate).toLocaleDateString()}</span>
            </div>
