  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        {visionImage ? (
          <div 
            className="aspect-video rounded-lg overflow-hidden bg-muted/20 cursor-pointer hover:scale-105 transition-transform group relative"
          ...
          <div 
            className="aspect-video rounded-lg bg-gradient-to-br from-purple-50 to-pink-50 border-2 border-dashed border-purple-200 flex items-center justify-center cursor-pointer hover:scale-105 transition-transform"
            onClick={() => navigate('/tools/vision')}
          >
